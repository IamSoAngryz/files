...
Modulul os (built-in)
    - lucrul cu fisiere din sistemul operare (operating system)
...
def delete_file(file):
    if os.path.exists(file):
        ...
        print(f'Fisierul {file} nu exita pe disc')
...
list_foldere_fisiere = os.listdir()
for item in list_foldere_fisiere:
    print(item)
print(f'Numarul de fisiere si foldere: {len(list_foldere_fisiere)}')
try:
    os.remove('tari2.txt')
...
# else:
#     print('Fisierul nu exita pe disc')
