...
Nested data  = date imbricate, structuri de date (colectii) care au ca elemente
            alte colectii de date - liste, dictionare in care valorile
...
print(f'Valoarea asociata cheii adress este: {nested_dict["address"]["street"]}')

#conversia unui liste imbricate / nested la o lista flat / uniforma
flattened_list = []
